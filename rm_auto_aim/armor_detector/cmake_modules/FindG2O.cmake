...
IF(UNIX)
  ...
  # Build vcpkg search paths from VCPKG_ROOT environment variable
  set(_G2O_SEARCH_PATHS /usr/local /usr)
  if(DEFINED ENV{VCPKG_ROOT})
    list(APPEND _G2O_SEARCH_PATHS "$ENV{VCPKG_ROOT}/installed/x64-linux")
  endif()
  list(APPEND _G2O_SEARCH_PATHS ${CMAKE_PREFIX_PATH})

  MESSAGE(STATUS "Searching for g2o ...")
  FIND_PATH(G2O_INCLUDE_DIR
    NAMES core math_groups types
    PATHS ${_G2O_SEARCH_PATHS}
