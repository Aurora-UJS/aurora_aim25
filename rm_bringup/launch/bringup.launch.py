...
def generate_launch_description():
    ...
    robot_navigation_description = Command(
        [
            "xacro ",
            os.path.join(
                get_package_share_directory("rm_robot_description"),
    ...
    if launch_params["video_play"]:
        image_node = ComposableNode(
            ...
            plugin="aurora::camera_driver::VideoPlayerNode",
            name="video_player",
        ...
        image_node = ComposableNode(
            package="rm_camera_driver",
            plugin="aurora::camera_driver::DahengCameraNode",
            name="camera_driver",
    ...
    armor_detector_node = ComposableNode(
        ...
        plugin="aurora::auto_aim::ArmorDetectorNode",
        name="armor_detector",
    ...
    rune_detector_node = ComposableNode(
        ...
        plugin="aurora::rune::RuneDetectorNode",
        name="rune_detector",
